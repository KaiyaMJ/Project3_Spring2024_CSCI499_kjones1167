...
$id = getId($link); // Get the next available ID
$queryInsert = "INSERT INTO fooditems (id, item, amount, unit, calories, protein, carbohydrate, fat) VALUES ('$id', '$item', '$amount', '$unit', '$calories', '$protein', '$carbohydrate', '$fat');";
...
if (isset($_POST['delete_id'])) {
    ...
    // Query to delete the record with the specified ID
    $queryDelete = "DELETE FROM fooditems WHERE id='$delete_id';";
    ...
    <body>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <table>
                <tr>
                    <td>Item:</td>
                    <td><input type="text" name="item" id="insert_item"></td>
                 </tr>
                 <tr>
                    <td>Amount:</td>
                    <td><input type="text" name="amount" id="insert_amount"></td>
                 </tr>
                 <tr>
                    <td>Unit:</td>
                    <td><input type="text" name="unit" id="insert_unit"></td>
                 </tr>
                 <tr>
                    <td>Calories:</td>
                    <td><input type="text" name="calories" id="insert_calories"></td>
                </tr>
                <tr>
                    <td>Protein:</td>
                    <td><input type="text" name="protein" id="insert_protein"></td>
                </tr>
                <tr>
                    <td>Carbohydrate:</td>
                    <td><input type="text" name="carbohydrate" id="insert_carbohydrate"></td>
                </tr>
                <tr>
                    <td>Fat:</td>
                    <td><input type="text" name="fat" id="insert_fat"></td>
                </tr>
            </table>    
